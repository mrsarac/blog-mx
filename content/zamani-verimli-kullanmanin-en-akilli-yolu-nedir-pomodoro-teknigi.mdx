...
subtitle: 'Pomodoro Tekniği ile zaman yönetimi'
date: '2015-01-28T00:00:00.000Z'
updated: '2015-01-28T00:00:00.000Z'
categories: ['Zaman Yönetimi', 'Verimlilik', 'Kişisel Gelişim']
slug: zamani-verimli-kullanmanin-en-akilli-yolu-nedir-pomodoro-teknigi
type: 'blogPost'
featured: false
language: 'tr'
---
...
1 **Pomodoro** = 25 dk + 5 dk dinlenme
...
- Bir üniteyi 2 saatte okurum (4p)
...
1. Ünitelerin isimlerini liste yaptım. (Önümü gördüm)
2. Her ünitenin tek tek sayfa sayısına baktım.
3. Sayfa sayısına göre her bir üniteye kaç **pomodoro** gideceğini hesapladım ve yazdım. (Yani öncelikle 1 **pomodoro** zaman tutarak ne kadar sayfa ilerleyebildiğime baktım bunu baz aldım. Veriler konuşur!)

Bazı yerler fazla uzun olduğundan onların sürelerini +1p daha uzun yaptığımda oldu. Ama genel olarak tüm üniteleri önümde ve kaç **pomodoro** ile yapacağımı gördüğümde sanki işi bitirmişçesine rahattım ve stresim gitmişti. Bu işi parçalara ayırma konusu benim için gerçekten çok önemli. Çalışacağım dersler ilk başlarda kesinlikle bitmeyecek gibiydi. Güzel bir stres kaynağı, ama belirlediğim sürelerden (**pomodoro**) sonra tüm stresim gitmişti. Çünkü artık tüm çalışmayı sınava kadar yetiştirebileceğimi biliyordum, gözümün önünde görüyordum ve kurallara uyduğum sürece (25 dk + 5 dk mola) yetişebileceğimi biliyordum.
...
- [Tomato Timer](http://tomatoi.st/ojbz)
...
Uygulama olarak isterseniz Google'da “**pomodoro timer**” diye arama yaparak kendinize uygun bir zaman takip uygulaması kullanabilirsiniz.
