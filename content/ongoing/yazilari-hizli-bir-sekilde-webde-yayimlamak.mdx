...
subtitle: 'Webde içerik yayımlamak için verimli yöntemler'
date: '2023-10-01T00:00:00.000Z'
updated: '2023-10-01T00:00:00.000Z'
categories: ['Yazılım', 'Web Geliştirme', 'Verimlilik']
slug: yazilari-hizli-bir-sekilde-webde-yayimlamak
type: 'blogPost'
featured: false
language: 'tr'
---
...
Tabi burada eklemek istediğim bir nokta var. Dosyanın başına eklenebilecek bir YAML tanımlaması var, dosyanın hangi isimde ve kategoride olacağını belirleyebiliyorum.
